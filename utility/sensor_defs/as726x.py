...
class AS726xMonitor:
    ...
    def read(self, SIO):
        ...
        SIO.DBL.log_readout(self.R_id, r, self.t)
        SIO.DBL.log_readout(self.O_id, o, self.t)
        SIO.DBL.log_readout(self.Y_id, y, self.t)
        SIO.DBL.log_readout(self.G_id, g, self.t)
        SIO.DBL.log_readout(self.B_id, b, self.t)
        SIO.DBL.log_readout(self.V_id, v, self.t)
